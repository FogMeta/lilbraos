<template>
  <div class="netchange-pop">
    <el-dialog v-model="props.networkC" title="Please switch to our supported network environment. Network Env List:" :close-on-click-modal="false" :show-close="true" class="net_body" @close="beforeClose">
...
export default defineComponent({
  ...
  setup (props, context) {
    ...
    const metamaskImg = require('@/assets/images/metamask.png')
