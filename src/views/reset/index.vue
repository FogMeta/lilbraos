        ...
        <el-row>
          <el-col :xs="20" :sm="10" :md="8" :lg="6" :xl="6">
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" class="demo-ruleForm" status-icon @submit.native.prevent>
              ...
              <el-form-item prop="code">
                <label class="label" for="code">
                  <div class="flex flex-row">
                    ...
                    <el-button type="info" class="el-code" size="large" disabled v-if="sms.disabled">Try again in {{sms.count}}s</el-button>
              ...
              <el-form-item>
                <el-button type="primary" size="large" @click="submitForm('ruleFormRef')">Reset password</el-button>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
    ...
    const submitForm = async (formEl) => {
      ...
      await ruleFormRef.value.validate(async (valid, fields) => {
        ...
        if (valid) {
          ...
          const userRes = await system.$commonFun.sendRequest(`${process.env.VUE_APP_BASEAPI}/user/login`, 'put', emailParams)
          if (userRes && userRes.code === 0) {
            system.$commonFun.messageTip('success', userRes.msg ? userRes.msg : 'Reset successfully!')
            system.$commonFun.signOutMeta()
          } else system.$commonFun.messageTip('error', userRes.msg ? userRes.msg : 'Reset Failed!')
