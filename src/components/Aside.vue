<template>
  <div class="aside-main">
    <el-menu active-text-color="#fff" text-color="rgb(158, 158, 158)" background-color="transparent" class="el-menu-vertical-demo" :default-active="activeIndex" :collapse="isCollapse" @open="handleOpen" @close="handleClose">
      <el-menu-item index="0">
        <a class="root flex-row" target="_blank" href="/new-deployment">
          <span class="hide">Deploy</span>
          <i class="el-icon width-24 small">
      ...
      <el-menu-item index="6" class="menu">
        <i class="el-icon width-24">
      ...
      <el-menu-item index="8" class="menu">
        <i class="el-icon width-24">
      ...
      <el-menu-item index="9" class="menu">
        <i class="el-icon width-24">
      ...
      <li class="el-menu-item hide" index="10">
        <div class="mainnet">
          ...
          <div class="net-root font-12 flex-row">
            <span>akashnet.net</span>
            <span>276ms</span>
            <span class="border"></span>
          </div>
        </div>
        <div class="support flex-row">
          <span class="font-10">Support our Validator </span>
          <i class="el-icon width-24 small">
      ...
      <li class="el-menu-item hide" index="11">
        <div class="media-root flex-row">
          <ul class="flex-row">
            <li class="el-icon width-24">
      ...
      <li class="el-menu-item" index="12">
        <div class="foot-collapse">
          <div class="button">
            <svg v-show="!isCollapse" @click="isCollapse = true" class="width-24" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="MenuOpenIcon">
              <path d="M3 18h13v-2H3v2zm0-5h10v-2H3v2zm0-7v2h13V6H3zm18 9.59L17.42 12 21 8.41 19.59 7l-5 5 5 5L21 15.59z"></path>
            </svg>
            <svg v-show="isCollapse" @click="isCollapse = false" class="width-24" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="MenuIcon">
...
export default defineComponent({
  ...
  setup () {
    ...
    async function handleSelect (key, keyPath) {
      if (key === '1') router.push({ name: 'home' })
    ...
    async function activeMenu (row) {
      ...
      if (nameMenu.indexOf('home') > -1) activeIndex.value = '1'
