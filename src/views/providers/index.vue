<template>
  <section id="container-providers" :class="{'lang-max top-margin both-margin': true, 'loading': providersLoad}">
    <div class="module">
      <h1 class="font-24 weight-6 both-margin">Network Capacity</h1>
      <h3 class="font-16 weight-4 both-margin">
        <span class="font-20 weight-6">{{pagin.total}}</span> active providers on Mainnet</h3>
      ...
      <div class="providers-overview">
        <el-row :gutter="30" class="erchart-body">
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <div class="erchart">
              <div class="font-16 weight-4">VCPU</div>
              <h6 class="font-12 weight-4">Current VCPU usage</h6>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <div class="erchart">
              ...
              <h6 class="font-12 weight-4">Current Memory usage</h6>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <div class="erchart">
              ...
              <h6 class="font-12 weight-4">Current Storage usage</h6>
          ...
          <el-col :xs="24" :sm="12" :md="6" :lg="6" :xl="6">
            <div class="erchart">
              <div class="font-16 weight-4">GPU</div>
              <h6 class="font-12 weight-4">Current GPU usage</h6>
...
import { ElButton, ElRow, ElCol, ElDivider, ElTable, ElTableColumn, ElPagination, ElSelect, ElOption, ElOptionGroup, ElInput, ElIcon, ElCheckbox, ElCheckboxGroup } from "element-plus"
...
export default defineComponent({
  components: {
    ...
    ElTable,
    ElTableColumn,
    ElPagination, ElSelect, ElOption, ElOptionGroup,
    ElInput, ElIcon, ElCheckbox, ElCheckboxGroup
  },
  setup () {
        ...
        series: [
          {
            ...
            itemStyle: {
              ...
              shadowBlur: 2,
              shadowColor: 'rgba(72, 176, 255, 0.8)'
            },
            data: dataArr,
            symbolSize: 10,
            zlevel: 1
    ...
    const changetype = () => {
      ...
      const option = {
        ...
        color: ['rgba(72, 176, 255, 1)', '#9e9e9e'],
        series: [
          {
            name: 'Total',
            type: 'pie',
